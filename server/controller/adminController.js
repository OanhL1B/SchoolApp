...
export const addAdmin = async (req, res) => {
  try {
    ...
    var date = new Date();
    var components = ["ADMIN", date.getFullYear(), departmentHelper, helper];
...
export const addFaculty = async (req, res) => {
  try {
    ...
    var date = new Date();
    var components = ["GV", date.getFullYear(), departmentHelper, helper];
...
export const addStudent = async (req, res) => {
  try {
    ...
    var date = new Date();
    var components = ["N", date.getFullYear(), departmentHelper, helper];
